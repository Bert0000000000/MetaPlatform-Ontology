# MP-V6-ONTOLOGY-GEN-01 - ACCEPTANCE

> **状态**：Skeleton Accepted (待用户在宿主机完成 dsh preset 应用 + E2E)
> **日期**：2026-08-20
> **关联 Batch**：[MP-V6-ONTOLOGY-GEN-01.md](../batch/MP-V6-ONTOLOGY-GEN-01.md)
> **关联 PRD**：[ontology-gen.md](../prd/ontology-gen.md)
> **前置依赖**：MP-V6-AUTH-01 ✅ + MP-V6-HITL-HUB-01 ✅ + MP-V6-TEMPORAL-01 ✅ + MP-V6-DSH-01 ✅
...
|  `docs/active/batch/MP-V6-ONTOLOGY-GEN-01.md` | Batch doc |
|  `evidence/MP-V6-ONTOLOGY-GEN-01-ACCEPTANCE.md` | (本文档) |
...
- **MP-V6-EDGE-FN-01** (6w) — 17 域业务迁移到 Edge Functions (ontology 是 Kernel 基础)
