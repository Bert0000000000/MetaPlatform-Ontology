# MP-V6-DEPLOY-01 - ACCEPTANCE

> **状态**：Skeleton Accepted (待用户在宿主机完成 ArgoCD + Image Updater 部署)
> **日期**：2026-08-20
> **关联 Batch**：[MP-V6-DEPLOY-01.md](../batch/MP-V6-DEPLOY-01.md)
...
| `evidence/MP-V6-DEPLOY-01-ACCEPTANCE.md` | (本文档) |
...
- **MP-V6-LONG-TASK-01** (4w) — 1 周+ 长任务 5 大机制完整化
- **MP-V6-DOMAIN-MIGRATE-01** (8w) — 17 域业务迁移
- **MP-V6-V6.1-PREP** (2w) — v6.1 路线图
