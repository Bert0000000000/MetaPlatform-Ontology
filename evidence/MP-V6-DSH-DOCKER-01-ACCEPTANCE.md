# MP-V6-DSH-DOCKER-01 - ACCEPTANCE (Skeleton Phase)

> **状态**：Skeleton Accepted
> **日期**：2026-08-20
> **关联 Batch**：[MP-V6-DSH-DOCKER-01.md](../batch/MP-V6-DSH-DOCKER-01.md)
...
- MP-V6-DSH-K8S-01 (Deployment + HPA + Service + Ingress)
- MP-V6-DSH-POSTGRES-BACKEND-01 (本仓库已含 skeleton 在 `packages/mp-dsh-postgres-backend/`)
