# MP-V6-RAG-01 - ACCEPTANCE

> **状态**：Skeleton Accepted (待用户在宿主机完成 RAGFlow/GraphRAG 部署 + E2E)
> **日期**：2026-08-20
> **关联 Batch**：[MP-V6-RAG-01.md](../batch/MP-V6-RAG-01.md)
> **关联 PRD**：[rag-dual-engine.md](../prd/rag-dual-engine.md)
> **前置依赖**：MP-V6-FOUNDATION-01 ✅ + MP-V6-LLM-01 ✅ + MP-V6-DSH-01 ✅
...
| `evidence/MP-V6-RAG-01-ACCEPTANCE.md` | (本文档) |
...
✅ RAG-01 骨架完成。下游可启动:
- **MP-V6-DEPLOY-01** (2w) — Helm chart + ArgoCD 收口 (Sprint 3 起点)
