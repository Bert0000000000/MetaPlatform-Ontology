# MP-V6-AUTH-01 - ACCEPTANCE

> **状态**：Skeleton Accepted (待用户在宿主机完成 live-deploy + OAuth e2e)
> **日期**：2026-08-20
> **关联 Batch**：[MP-V6-AUTH-01.md](../batch/MP-V6-AUTH-01.md)
...
| `docs/active/batch/MP-V6-AUTH-01.md` | Batch 任务文档 |
...
✅ AUTH-01 骨架完成。下游可启动:
- **MP-V6-HITL-HUB-01** (4w) — JWT 验证模板就绪
- **MP-V6-DSH-01** (4w) — dsh Web 用 JWT 调 Supabase
- **MP-V6-ONTOLOGY-GEN-01** (4w) — apply-ontology-change Edge Function 用 _template-auth
