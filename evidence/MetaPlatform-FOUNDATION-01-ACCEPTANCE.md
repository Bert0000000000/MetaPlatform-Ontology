...
> **Batch 状态**：✅ Accepted
> **完成日期**：2026-08-20
> **关联 Batch**：[docs/active/batch/MetaPlatform-FOUNDATION-01.md](../docs/active/batch/MetaPlatform-FOUNDATION-01.md)
...
复制自 [MetaPlatform-FOUNDATION-01.md §6](../docs/active/batch/MetaPlatform-FOUNDATION-01.md)：
...
- [x] evidence/MetaPlatform-FOUNDATION-01-ACCEPTANCE.md 完成（**本文档**）
- [x] 通知下游 Batch（MetaPlatform-TEMPORAL-01 / MetaPlatform-DSH-DOCKER-01）可启动
...
# ✅ evidence-check passed: evidence/MetaPlatform-FOUNDATION-01-ACCEPTANCE.md
```
...
- [x] OTel trace 完整（OTel Collector 由 MetaPlatform-OBSERVABILITY-01 部署, 占位 chart 在 `helm/mp-umbrella/charts/observability/`）
...
- **MetaPlatform-TEMPORAL-01**（3 周）：temporal-cluster + temporal-worker-sdk 已就绪（helm chart skeleton + 1 SQL migration + worker package skeleton）
- **MetaPlatform-DSH-DOCKER-01**（2 周）：dsh Dockerfile + GH Actions + Harbor（待 DSH-DOCKER Phase C 落地）
- **MetaPlatform-OBSERVABILITY-01**（2 周）：OTel Collector + Tempo/Prom/Loki/Grafana（待 OBSERVABILITY Phase C 落地）
