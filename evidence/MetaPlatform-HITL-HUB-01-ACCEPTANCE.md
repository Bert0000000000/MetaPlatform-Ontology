# MetaPlatform-HITL-HUB-01 - ACCEPTANCE

> **状态**：Skeleton Accepted (待用户在宿主机完成 pg_cron + E2E 验证)
> **日期**：2026-08-20
> **关联 Batch**：[MetaPlatform-HITL-HUB-01.md](../batch/MetaPlatform-HITL-HUB-01.md)
...
| `docs/active/batch/MetaPlatform-HITL-HUB-01.md` | Batch doc |
...
- **MetaPlatform-APPROVAL-01** (6w) — 第三方审批 SaaS 多级超时升级
- **MetaPlatform-LONG-TASK-01** (4w) — 1 周+ 长任务 5 大机制 (本 Batch 已部分实现)
