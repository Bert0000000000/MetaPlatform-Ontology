# MetaPlatform-DSH-01 - ACCEPTANCE
...
> **前置依赖**：MetaPlatform-FOUNDATION-01 ✅ + MetaPlatform-DSH-DOCKER-01 ✅
...
| `docs/active/batch/MetaPlatform-DSH-01.md` | Batch doc |
...
✅ DSH-01 骨架完成。下游可启动:
- **MetaPlatform-LLM-01** (2w) — LLM provider 详细配置 (从本 Batch 抽离)
- **MetaPlatform-SANDBOX-01** (待定) — dsh sandbox + K8s Job (从本 Batch 抽离)
- **MetaPlatform-HITL-HUB-01** (4w) — dsh tool HITL (tool_dsh 类型)
