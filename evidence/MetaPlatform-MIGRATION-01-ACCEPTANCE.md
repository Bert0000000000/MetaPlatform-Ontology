# MetaPlatform-MIGRATION-01 - ACCEPTANCE

> **状态**：Skeleton Accepted (待用户在宿主机完成 live-ETL + 切流量演练)
> **日期**：2026-08-20
> **关联 Batch**：[MetaPlatform-MIGRATION-01.md](../batch/MetaPlatform-MIGRATION-01.md)
> **关联 PRDs**（3 份）：
...
复制自 [MetaPlatform-MIGRATION-01.md §8](../batch/MetaPlatform-MIGRATION-01.md)：
...
- [x] **evidence/MetaPlatform-MIGRATION-01-ACCEPTANCE.md** 写完（**本文档**）
...
- [x] spec 一致性（参考 `MetaPlatform-MIGRATION-01.md` §3-7）
