# MP-V6-EDGE-FN-01 — 17 域业务迁移到 Edge Functions

> **Batch 状态**：Pending Acceptance
> **优先级**：🔴 P2（17 域业务核心）
> **工作量**：6 周
> **团队**：后端 + SRE
> **前置依赖**：MP-V6-AUTH-01 ✅ + MP-V6-ONTOLOGY-GEN-01 ✅
...
- [ ] 跨域 JOIN 验证
- [ ] RLS 跨 tenant 测试
- [ ] evidence/MP-V6-EDGE-FN-01-ACCEPTANCE.md
...
*MP-V6-EDGE-FN-01 — Sprint 2 业务迁移就绪*