...
> **对应 Batch**：[MetaPlatform-HITL-HUB-01](../batch/MetaPlatform-HITL-HUB-01.md)
> **状态**：Draft v1.0
> **负责人**：SRE + 后端
> **日期**：2026-08-20
...
| 依赖 | 来源 |
|---|---|
| Supabase PG + RLS | MetaPlatform-FOUNDATION-01 ✅ |
...
*PRD v1.0 — 配套 [MetaPlatform-HITL-HUB-01 Batch](../batch/MetaPlatform-HITL-HUB-01.md)*