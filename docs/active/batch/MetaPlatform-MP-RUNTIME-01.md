# MetaPlatform-MP-RUNTIME-01 — mp-runtime 业务运行时 (Edge Functions)

> **Batch 状态**：✅ Accepted
> **优先级**：🟢 v6.0 must (19 应用之一)
> **工作量**：1d (3 Edge Functions + DB schema + E2E)
> **团队**：AI 团队 + SRE
> **前置依赖**：MetaPlatform-FOUNDATION-01 ✅ (Supabase + RLS + Edge Functions)
...
| `evidence/MetaPlatform-MP-RUNTIME-01-ACCEPTANCE.md` | 验收证据 |
| `docs/active/batch/MetaPlatform-MP-RUNTIME-01.md` | 本文件 |

## 9. 已知边界 / 待办 (下个 iteration)

| 项 | 说明 |
|---|---|
| AC4 OTel trace | 待 MetaPlatform-OBSERVABILITY-01 Batch |
...
*MetaPlatform-MP-RUNTIME-01 Accepted — 2026-08-20 — 3 Edge Functions shipped, 4/4 E2E pass*