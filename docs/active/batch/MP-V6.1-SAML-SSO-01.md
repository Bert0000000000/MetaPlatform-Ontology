# docs/active/batch/MP-V6.1-SAML-SSO-01.md (实际文件: v6.1 batch doc 写在下文)
# MP-V6.1-SAML-SSO-01 — v6.1 SAML SSO 集成
...
- [x] evidence/MP-V6.1-SAML-SSO-01-ACCEPTANCE.md
...
*MP-V6.1-SAML-SSO-01 — v6.1 must 集成大客户*