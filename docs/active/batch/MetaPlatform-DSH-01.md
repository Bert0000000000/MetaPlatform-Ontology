# MetaPlatform-DSH-01 — dsh 数字员工集成
...
- [ ] evidence/MetaPlatform-DSH-01-ACCEPTANCE.md
...
- MetaPlatform-LLM-01（LLM provider 详细配置）
- MetaPlatform-SANDBOX-01（dsh sandbox + K8s Job）
- MetaPlatform-HITL-HUB-01（dsh tool HITL）

---

*MetaPlatform-DSH-01 — Sprint 1 数字员工集成就绪*