# MP-V6-AUTH-01 — Supabase Auth + RLS + JWT
...
- [ ] evidence/MP-V6-AUTH-01-ACCEPTANCE.md
...
本 Batch 完成后可启动：
- MP-V6-HITL-HUB-01（依赖 JWT 解析）
- MP-V6-DSH-01（dsh Web 用 JWT 调 Supabase）
- MP-V6-ONTOLOGY-GEN-01（apply-ontology-change Edge Function）

---

*MP-V6-AUTH-01 — Sprint 1 Auth 层就绪*