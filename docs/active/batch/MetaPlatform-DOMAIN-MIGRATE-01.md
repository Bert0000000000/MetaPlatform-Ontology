# MetaPlatform-DOMAIN-MIGRATE-01 — 17 域业务从 v3 → v6 迁移

> **Batch 状态**：Pending Acceptance
> **优先级**：🔴 P3（业务核心）
> **工作量**：8 周
> **团队**：后端 + AI 团队
> **前置依赖**：MetaPlatform-EDGE-FN-01 ✅ + MetaPlatform-ONTOLOGY-GEN-01 ✅ + MetaPlatform-MIGRATION-01 ✅
...
*MetaPlatform-DOMAIN-MIGRATE-01 — Sprint 3 业务迁移*