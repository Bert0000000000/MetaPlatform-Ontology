# MetaPlatform.1-APP-CENTER-01 — v6.1 App Center MVP
...
- **v6.1 路线图**：[v6.1-roadmap.md §4 MetaPlatform.1-APP-CENTER-01](../v6.1-roadmap.md)
...
- [ ] Playwright E2E (8/8)
- [ ] evidence/MetaPlatform.1-APP-CENTER-01-ACCEPTANCE.md
- [ ] 更新 v6.1-roadmap 状态
...
*MetaPlatform.1-APP-CENTER-01 — v6.1 App Center MVP — this iteration (4w, 5 loops)*