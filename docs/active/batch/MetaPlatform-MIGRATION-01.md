# MetaPlatform-MIGRATION-01 — v3.0 → v6.0 数据 ETL

> **Batch 状态**：Pending Acceptance
> **优先级**：🔴 P0（v6.0 GA 必做）
> **工作量**：2-3 周
> **团队**：SRE + 后端
> **前置依赖**：MetaPlatform-FOUNDATION-01 + Sprint 3 启动
...
- [ ] evidence/MetaPlatform-MIGRATION-01-ACCEPTANCE.md
...
- [ ] 按租户切流量：100% 完成
- [ ] v3.0 标记 deprecated
- [ ] evidence/MetaPlatform-MIGRATION-01-ACCEPTANCE.md 写完
- [ ] 通知「v6.0 GA」准备就绪
...
Sprint 1 (Q1-2027) ─────┤
                          ├─→  Sprint 3 末
Sprint 2 (Q1-Q2-2027) ──┤     启动 MetaPlatform-MIGRATION-01
                          │     （与 Sprint 3 重叠）
Sprint 3 (Q2-Q3-2027) ──┘
```

MetaPlatform-MIGRATION-01 在 Sprint 3 第 5 周启动，2-3 周完成。
...
| 冷存储（S3 / OSS）| MetaPlatform-FOUNDATION-01 |
...
> **MetaPlatform-MIGRATION-01 = 一次性 ETL：导出 v3.0 4 类数据（用户 / 租户 / 17 域 / 审计日志）→ 导入 v6.0 Supabase，2-3 周完成。代码零迁移、数据零双写、按租户切流量、Sprint 3 末 v3.0 退役。**

---

*MetaPlatform-MIGRATION-01 完全抛弃 v3.0 数据迁移 Batch。*