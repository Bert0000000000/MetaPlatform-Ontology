# MetaPlatform-FOUNDATION-01 — Supabase + K8s 基础设施
...
- [ ] 写 BACKUP_RPO_RTO 文档
- [ ] evidence/MetaPlatform-FOUNDATION-01-ACCEPTANCE.md 落地
- [ ] 通知下游 Batch 可启动
...
- [ ] evidence/MetaPlatform-FOUNDATION-01-ACCEPTANCE.md 完成
- [ ] 通知下游 Batch（MetaPlatform-TEMPORAL-01 / MetaPlatform-DSH-DOCKER-01）可启动
