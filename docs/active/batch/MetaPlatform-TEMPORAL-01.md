# MetaPlatform-TEMPORAL-01 — Temporal Cluster 部署
...
- [ ] 24h 长任务测试通过
- [ ] OTel metrics 上报配置
- [ ] evidence/MetaPlatform-TEMPORAL-01-ACCEPTANCE.md 完成
- [ ] 通知下游 Batch（MetaPlatform-TEMPORAL-TS-01 / MetaPlatform-HITL-HUB-01）可启动
...
本 Batch 完成后可启动：
- MetaPlatform-TEMPORAL-TS-01（Temporal worker Node SDK）
- MetaPlatform-HITL-HUB-01（HITL Hub）
- MetaPlatform-APPROVAL-01（审批 SaaS 适配）