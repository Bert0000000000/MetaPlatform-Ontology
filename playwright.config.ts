...
export default defineConfig({
  ...
  projects: [
    {
      name: 'supabase-api',
      testMatch: /e2e\/(supabase|edge-functions|list-presets|publish-preset|install-preset|uninstall-preset|multimodal-rag|mp-runtime|mp-knowledge|mp-sandbox)\.spec\.ts/,
